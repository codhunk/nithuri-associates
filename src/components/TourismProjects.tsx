        ...
        <section className="py-24 bg-cream dark:bg-primary-light/5">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl font-bold text-primary dark:text-white mb-6">Tourism & Development Projects</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {projects.map((project, idx) => (
                        <div key={idx} className="group relative rounded-3xl overflow-hidden aspect-[4/5] shadow-xl">
                            <img
                                src={project.image}
                                alt={project.title}
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/20 to-transparent p-8 flex flex-col justify-end">
                                <div className={`${project.color} w-12 h-12 rounded-2xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform`}>
                                ...
                                <button className="flex items-center gap-2 text-accent font-bold text-sm">
                                    Project Details
                                    <ArrowRight size={16} />
                                </button>
                            </div>
