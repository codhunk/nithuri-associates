    ...
    return (
        <main className="min-h-screen bg-white dark:bg-primary">
            ...
            <div className="pt-20">
                ...
                <section className="py-24 border-t border-primary/5 bg-cream dark:bg-white/5">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="mb-16 text-center">
                            <h2 className="text-4xl font-bold text-primary dark:text-white mb-6">Property Buying <span className="text-accent">Protocol</span></h2>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={idx} className="bg-white dark:bg-primary p-8 rounded-[2rem] border border-primary/5 group hover:bg-accent hover:text-primary transition-all duration-500">
                                    ...
                                    <p className="text-xs text-primary/60 dark:text-white/60 group-hover:text-primary/80 leading-relaxed transition-colors">
                                        {step.desc}
                                    </p>
                                </div>
                            ))}
