        ...
        <main className="min-h-screen bg-white dark:bg-primary">
            ...
            <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-5xl font-bold text-primary dark:text-white mb-6">Empowering <span className="text-growth">Communities</span></h1>
                    <p className="text-primary/60 dark:text-white/60 max-w-2xl mx-auto text-lg">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {initiatives.map((item, idx) => (
                        <div key={idx} className="flex gap-6 p-10 bg-cream dark:bg-white/5 rounded-[2.5rem] border border-primary/5">
                            <div className="w-16 h-16 bg-growth/10 rounded-2xl flex items-center justify-center text-growth shrink-0">
                                <item.icon size={32} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold text-primary dark:text-white mb-4">{item.title}</h3>
                                <p className="text-primary/60 dark:text-white/60 leading-relaxed">
                                    {item.desc}
                                </p>
                            </div>
                        </div>
                ...
                <div className="mt-20 grid lg:grid-cols-2 gap-12 items-center bg-accent/5 p-12 rounded-[3rem] border border-accent/20">
                    <div>
                        <h2 className="text-3xl font-bold text-primary dark:text-white mb-6">Need Assistance?</h2>
                        <p className="text-primary/70 dark:text-white/70 mb-8 leading-relaxed">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <span className="px-4 py-2 bg-white dark:bg-white/10 rounded-full text-xs font-bold text-primary dark:text-white border border-primary/5">100% Free Service</span>
                            <span className="px-4 py-2 bg-white dark:bg-white/10 rounded-full text-xs font-bold text-primary dark:text-white border border-primary/5">No Hidden Charges</span>
                        </div>
                    </div>
                    <div className="flex justify-end">
                        <a href="/contact" className="bg-primary text-white dark:bg-accent dark:text-primary px-10 py-5 rounded-2xl font-bold text-lg shadow-xl hover:scale-105 transition-transform">
