        ...
        <main className="min-h-screen bg-white dark:bg-primary">
            ...
            <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-5xl font-bold text-primary dark:text-white mb-6">Partner in Our <span className="text-accent">Growth</span> Journey</h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {investorHilites.map((item, idx) => (
                        <div key={idx} className="p-8 bg-cream dark:bg-white/5 rounded-3xl border border-primary/5 hover:border-accent/40 transition-all">
                            <div className="w-12 h-12 bg-accent/20 rounded-2xl flex items-center justify-center text-accent mb-6">
                                <item.icon size={24} />
                            </div>
                            <h3 className="text-xl font-bold text-primary dark:text-white mb-4">{item.title}</h3>
