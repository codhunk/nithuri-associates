            ...
            <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
                    <div>
                        ...
                        <h1 className="text-5xl font-bold text-primary mb-8">Real Estate <span className="text-accent">Investment</span> Guide</h1>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="flex gap-4 p-6 bg-cream rounded-2xl border border-primary/5">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="p-8 border border-primary/5 rounded-3xl bg-accent/5">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-primary">Market Valuation</h3>
                    ...
                    <div className="p-8 border border-primary/5 rounded-3xl bg-growth/5">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-primary">Regional Connectivity</h3>
                        <p className="text-sm text-primary/60 leading-relaxed">
                    ...
                    <div className="p-8 border border-primary/5 rounded-3xl bg-blue-500/5">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-primary">Registry Shield</h3>
                        <p className="text-sm text-primary/60 leading-relaxed">
