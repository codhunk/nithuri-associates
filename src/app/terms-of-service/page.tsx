        ...
        <main className="min-h-screen bg-white dark:bg-primary">
            ...
            <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
                ...
                <div className="prose dark:prose-invert max-w-none text-primary/70 dark:text-white/70 space-y-6">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-primary dark:text-white mb-4 italic">1. Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-primary dark:text-white mb-4 italic">2. Use License</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-primary dark:text-white mb-4 italic">3. Disclaimer</h2>
